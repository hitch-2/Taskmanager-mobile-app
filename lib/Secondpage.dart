...
class _SecondPageState extends State<SecondPage> {
  ...
  final _descCtrl = TextEditingController(
    text: 'This application is designed for super shops...',
  );
  bool _loading = false;
  ...
  // TaskCreatePage.dart (ИСПРАВЛЕНО)
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        ...
        children: [
          // 1. Слой фона: растягиваем изображение на весь экран
          Positioned.fill(
            child: Image.asset(
              "assets/MainBg.png",
              fit: BoxFit.cover, // Обеспечивает полное покрытие
            ),
          ),
          SafeArea(
                            ...
                            : () async {
                                ...
                                try {
                                  ...
                                  Navigator.pushReplacement(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          TaskCreatePage(project: created),
                                    ),
                                  );
                                } catch (e) {
                                  ScaffoldMessenger.of(context).showSnackBar(
